...
import { GOOD_GROUP, GROUP_ORDER, railCaption } from "./hud";

/**
 * The two pieces of the HUD refit that are logic rather than markup: which
 * tool the rail's caption strip names, and which group each good's Stores row
 * files itself under. Everything else about the refit is verified in the
 * browser, per `src/ui/CLAUDE.md`.
 */
